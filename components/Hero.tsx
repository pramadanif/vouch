...
const ChatBubble = ({
  ...
  <div className={`flex w-full mb-3 ${isMe ? 'justify-end' : 'justify-start'}`}>
    <div className={`max-w-[85%] relative shadow-sm ${isMe
    ...
    <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-8 items-center">
          ...
          {/* Left: Content */}
          <FadeIn direction="right" className="lg:col-span-7 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-up" style={{ animationDelay: '0.3s' }}>
              <Button size="lg" className="shadow-lg shadow-brand-action/20" onClick={() => window.location.href = '/create'}>
                Create Free Link
              </Button>
